...
Logger logger = LoggerFactory.getLogger(getClass());
    ...
    public  void  getChiefNote(){
        ...
        while(set.next()){
            ...
            note.setEncounterId(set.getString(2).replaceAll("\u0000", ""));
            note.setCreatedAt(set.getString(7).replaceAll("\u0000", ""));
            note.setUpdatedAt(set.getString(8));
            note.setNote(set.getString(4).replaceAll("\u0000", ""));
            note.setNoteType(set.getString(9).replaceAll("\u0000", ""));
            note.setEncounterDate(set.getString(6).replaceAll("\u0000", ""));
            note.setPatientMrNumber(set.getString(3).replaceAll("\u0000", ""));
            note.setEncounterType(set.getString(10).replaceAll("\u0000", ""));
        //    note.setRecalled(set.getBoolean(12));
            note.setPractitionerRoleType(set.getString(13).replaceAll("\u0000", ""));
            note.setPractitionerName(set.getString(14).replaceAll("\u0000", ""));
            note.setPractitionerId(set.getString(5).replaceAll("\u0000", ""));
         //  note.setEdited(set.getBoolean(11));
            note.setDataSource("his");
            notes.add(note);
        } 
    ...
    "    ProgressionComplaint <> '';";
        ...
        while(set.next()){
            ...
            note.setEncounterId(set.getString(2).replaceAll("\u0000", ""));
            note.setCreatedAt(set.getString(7).replaceAll("\u0000", ""));
            note.setUpdatedAt(set.getString(8).replaceAll("\u0000", ""));
       ...
       for(int i=0;i<rounds;i++){
        ...
        public  void  getCarePlan(){
            ...
            while(set.next()){
                EncounterNote note = new EncounterNote();
                note.setUuid(set.getString(1).replaceAll("\u0000", ""));
                note.setEncounterId(set.getString(2).replaceAll("\u0000", ""));
                note.setCreatedAt(set.getString(7).replaceAll("\u0000", ""));
                note.setUpdatedAt(set.getString(8));
                note.setNote(set.getString(4).replaceAll("\u0000", ""));
              ...
              //  note.setRecalled(set.getBoolean(12));
                ...
                note.setPractitionerName(set.getString(14).replaceAll("\u0000", ""));
                note.setPractitionerId(set.getString(5).replaceAll("\u0000", ""));
          //     note.setEdited(set.getBoolean(11).replaceAll("\u0000", ""));
                note.setDataSource("his");
                notes.add(note);
            } 
            int rounds =Math.round(notes.size()/1000);
