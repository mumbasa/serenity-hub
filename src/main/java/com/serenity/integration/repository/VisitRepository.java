...
public interface VisitRepository extends JpaRepository<Visits,Long>{
    ...
    @Query(value = "select * from visits where createdat is not null and visits.assignedtoid is not null  and externalsystem ='his' OFFSET ?1  LIMIT 1000",nativeQuery = true)
